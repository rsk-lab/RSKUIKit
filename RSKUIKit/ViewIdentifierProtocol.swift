...
/// The protocol to be adopted by a type of object that represents an identifier of the view.
public protocol ViewIdentifierProtocol: ObjectIdentifierProtocol {}
