//
// ViewDependenciesProtocol.swift
//
...
/// The protocol to be adopted by a type of object that represents dependencies of the view.
public protocol ViewDependenciesProtocol: ObjectDependenciesProtocol {}
