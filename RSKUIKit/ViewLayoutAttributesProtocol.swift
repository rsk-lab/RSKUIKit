//
// ViewLayoutAttributesProtocol.swift
//
...
/// The protocol to be adopted by a type of object that represents layout attributes of the view.
public protocol ViewLayoutAttributesProtocol: ObjectAttributesProtocol {
    
    // MARK: - Public Properties
    
    /// A size of bounds of the view.
