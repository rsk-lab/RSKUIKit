...
/// The protocol to be adopted by a type of object that represents attributes of the view.
public protocol ViewAttributesProtocol: ObjectAttributesProtocol {}
