...
/// The protocol to be adopted by a type of object that represents a controller of the view.
public protocol ViewControllerProtocol: ObjectControllerProtocol {}
